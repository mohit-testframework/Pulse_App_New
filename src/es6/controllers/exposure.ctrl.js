(function() {
  'use strict';
  pulse.controllers.controller('ExposureCtrl', function($scope, $device, $timelapse, $views, $stateParams, $ionicSideMenuDelegate) {
    var vm = this;
