  ...
  pulse.services.factory('$views', function($config, $menuItems, $platform) {
    ...
    var bugReportMode,
      ...
      function spliceCameraModel(camModel) {
        ...
        _.forEach(splicedWords, (word) => {
          _.forEach(camModelArray, (modelString, $index) => {
    ...
    return {
      ...
      computeDeltaEV: function(startShutter, startIso, finalShutter, finalIso) {
        var data;
      ...
      getCameraModel: function(metaData) {
        var prefix = ' ';
      ...
      getCameraType: function(metaData) {
        var camType;
      ...
      checkForAppUpdate: function(configObj){
        var recentApp;
      ...
      doesModelSupport: function(device, mode){
        ...
        var matchedItem = _.find(listedModels, (listedModel) => {
      ...
      parseS3FirmwareFile: function(firmwareFile){
      ...
      computeDeltaEVShutter: function(startShutter, finalShutter) {
      ...
      computeDeltaEVIso: function(startIso, finalIso) {
      ...
      computeShutterEv: function(shutterArray) {
        //get 4 values in the middle-ish
        //find the value '1'
        var oneIndex = _.findIndex(shutterArray, (item) => {
          return (this.str2Num(item.value)) == 1;
        });

        var twoIndex = _.findIndex(shutterArray, (item) => {
          return (this.str2Num(item.value)) == 2;
        });
      ...
      getMillisecondsFromShutter: function(shutterValue) {
      ...
      stringtoBuffer: function(str, len = 17) {
      ...
      integerToByteArray: function(number) {
        var mask = 0x000000FF;
      ...
      hexstringToByteArray: function(hexstr, retArray) {
      ...
      isCameraConnected: function(device) {
      ...
      isBtClassicConnected: function(device, checkForEnabledToo = false) {
        var result = false;
      ...
      detectVersion: function(versionString){
